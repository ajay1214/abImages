...
const Sidebar = () => {
  ...
  return (
    <aside className="sidebar">
      <div className="flex size-full flex-col gap-7">
        ...
        <nav className="sidebar-nav">
                ...
                return (
                  <li
                    ...
                    className={`sidebar-nav_element group ${
                      isActive ? "bg-sky-gradient text-white" : "text-gray-700"
                    }`}
                  >
          ...
          <SignedOut>
            ...
            {/* </Button> */}
            <div className="card ml-10 mb-2">
              <div className="card2 flex items-center justify-center h-full">
